...
// Dark-theme counterpart to Card.jsx, used only inside the Telegram Mini
// App (rendered via TelegramProductsSection). Kept as its own file instead
// of sprinkling `isTelegram ? ... : ...` through Card.jsx — same shape/
// props/behavior, different palette, zero risk to the main site's design.
export default function TelegramCard({ title, description, icon, badge, price, featured = false, href = "#" }) {
  return (
    <Link href={href} className="block h-full group">
      <motion.div
        ...
        className={`
          ...
          ${featured 
            ...
            : 'bg-[#16161a]/90 backdrop-blur-md border border-white/10 shadow-[0_30px_80px_rgba(0,0,0,0.4)] hover:shadow-[0_55px_130px_rgba(233,30,99,0.25)] hover:border-[#E91E63]/40'
          }
      ...
      >
        ...
        <div className={`
          ...
          ${featured ? 'bg-white/18' : 'bg-[#FF80AB]/10'}
          ...
          <motion.div
            ...
            className={`
              ...
              ${featured 
                ...
                : 'bg-white/5 border-2 border-[#E91E63]/25 shadow-[0_8px_25px_rgba(233,30,99,0.15)]'
              }
            `}
          >
            {icon || "💖"}
        ...
        <h3 className={`
          ...
          ${featured 
            ...
            : 'text-white group-hover:text-[#E91E63]'
          }
        ...
        <p className={`
          ...
          ${featured ? 'text-white/95' : 'text-white/50'}
        `}>
          {description}
        </p>
          ...
          <div className="mb-8">
            <div className={`
              ...
              ${featured 
                ...
                : 'bg-white/5 border border-[#E91E63]/30'
              }
            `}>
              <span className={`
              ...
              {price !== "₹0" && (
                <span className={`
                  ...
                  ${featured ? 'text-white/80' : 'text-white/40'}
                `}>
                  onwards
                </span>
              )}
        ...
        {/* CTA */}
        <div className={`mt-auto pt-6 border-t ${featured ? 'border-white/15' : 'border-white/10'}`}>
          <div className="flex items-center justify-between group/btn">
            <span className={`
              text-xs md:text-sm font-black uppercase tracking-[0.25em]
              ${featured ? 'text-white' : 'text-white/70 group-hover/btn:text-[#E91E63]'}
